    ...
    return (
        <div className="grid grid-cols-8 gap-4 bg-white">
            ...
            <div className="col-span-8 p-4">
                ...
                <h2 className="text-xl font-bold">Oregon Legislators</h2>
                    ...
                    {legislators.map(legislator => (
                        ...
                        <li className="toc-entry mb-2 border-b border-gray-200 py-6">
                            <a className="cursor-pointer" target="_new">
                                ...
                                <span className="block">{legislator.Title + ' ' + legislator.FirstName + ' ' + legislator.LastName}</span>
                                <span className="block">{legislator.EmailAddress}</span>
                            </a>
                        </li>
                    ))}
                </ul>
