                ...
                <div className="tablet:col-span-6 col-span-8 p-4">
                    <div className="min-h-screen">
                        <div className="relative w-full">
                            ...
                            <a href="#appendices" className="text-l font-bold mt-4 block relative left-0 top-0 mt-10 mr-4 text-sm text-blue-600 hover:underline">{chapter.appendices.length} Appendices in this chapter</a>
